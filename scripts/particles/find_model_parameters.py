...
def _identifiers(args: Namespace) -> str:
    ...
    id_str += f'_err={args.approx_error_limit}'
...
def _generate_or_load_data(
    ...
    if T is None:
        ...
        low_speeds, high_speeds, T = _calculate_data(args, ds)
        data = {
...
def find_parameters():
    ...
    ds, low_speeds, high_speeds, T = _generate_or_load_data(args, rebuild_cache=True, cache_only=False)
