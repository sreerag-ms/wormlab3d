...
def _init() -> Tuple[Path, Dataset, Eigenworms]:
    """
...
def prepare_dataset():
    ...
    shutil.copy(ew.components_path, save_dir / f'eigenworms_{ew.id}.npz')
    ...
    for i, trial in enumerate(ds.include_trials):
        ...
        if rec_id is not None:
            ...
            np.savez_compressed(reconst_dir / f'{trial.id:03d}_reconstruction={rec_id}.npz', X=Xr)
