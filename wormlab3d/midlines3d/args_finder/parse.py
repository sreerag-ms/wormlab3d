...
def parse_arguments(printout: bool = True) \
        -> Tuple[RuntimeArgs, SourceArgs, ParameterArgs, HeadAndTailOptimizationArgs]:
    """
    ...
    HeadAndTailOptimizationArgs.add_args(parser)
    ...
    head_and_tail_args = HeadAndTailOptimizationArgs.from_args(args)

    return runtime_args, source_args, parameter_args, head_and_tail_args
